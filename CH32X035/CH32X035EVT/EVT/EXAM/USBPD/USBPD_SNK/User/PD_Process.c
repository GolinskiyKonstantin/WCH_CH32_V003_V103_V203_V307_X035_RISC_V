 ...
 * @fn      PD_Rx_Mode
 *
 * @brief   This function uses to enter receiving mode.
 *
 * @return  none
 */
 ...
 * @fn      PD_Detect
 *
 * @brief   This function uses to detect cc insertion .
 *
 ...
 * @fn      PD_PDO_Analyse
 *
 * @brief   This function uses to analyse PD voltage and current.
 *
 * @return  none
 */
